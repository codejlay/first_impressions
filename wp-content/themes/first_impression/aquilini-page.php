<?php
/*
 Template Name: Aquilini Layout
 */

get_header(); ?>
	<div id="primary" class="content-area aquilini">
		<main id="main" class="site-main" role="main">
			...
			<div class="content-aquilini container">
				...
				<?php $pages = get_pages( array( 'child_of' => 44 ) ); ?>
